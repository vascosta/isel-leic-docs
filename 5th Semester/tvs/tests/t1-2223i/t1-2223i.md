...
```
Ao carregarmos a biblioteca com dlopen, o espaço de endereçamento do processo que a carrega criar uma nova região de data inicializada (.data) e uma nova região de código (.text).
```
