...
public class FuncionarioRep {
    ...
    public List<Object[]> obterFuncionáriosSemTarefas() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("JPAExemplo");
        EntityManager em = emf.createEntityManager();
        EntityTransaction tr = em.getTransaction();
        try {
            ...
            Query q = em.createQuery(
                "SELECT * FROM FuncionarioTarefa fT WHERE f.num = fT.id.num_func AND fT.id.id_tarefa != (SELECT id FROM Tarefa WHERE nome = 'Sem tarefa') GROUP BY f.num, f.nome");

            FuncionarioTarefa fT = em.getReference(FuncionarioTarefa.class, "isi");
